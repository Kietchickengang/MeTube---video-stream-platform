...
const SettingsPage = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-2 py-4">
      ...
      <p className="text-sm text-[#c0c0c0] leading-relaxed mb-8">
        Thiết lập cá nhân và tùy chọn giao diện sẽ được quản lý ở đây.
      </p>

      <div className="grid gap-6">
        <div className="rounded-3xl border border-[#272727] bg-[#121212] p-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <button
              ...
              className={`rounded-full px-5 py-3 text-sm font-semibold transition ${theme === 'dark' ? 'bg-[#1c62b9] text-white' : 'bg-[#222222] text-[#f1f1f1] hover:bg-[#2a2a2a]'}`}
            >
              Dark Theme
            </button>
            <button
              ...
              className={`rounded-full px-5 py-3 text-sm font-semibold transition ${theme === 'light' ? 'bg-[#1c62b9] text-white' : 'bg-[#e2e8f0] text-[#0f172a] hover:bg-[#cbd5e1]'}`}
            >
              Light Theme
            </button>
          </div>
